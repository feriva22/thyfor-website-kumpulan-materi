...
<html lang="en">
  ...
  <body>
    ...
    <main role="main">
        <div class="row ml-5 mt-5 mr-5">
            <div class="col-md-8">
                <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Daftar Topic</h5>
                  <div class="float-right">
                    <button class="btn btn-sm btn-primary" id="addTopicbtn">Tambah Topic</button>
                  </div>
                  <br><br>
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><?php echo $row->tpc_id;?></th>
                        <td><?php echo $row->tpc_nama;?></td>
                        <td><?php echo $row->tpc_deskripsi;?></td>
                        <td>
                        <a onClick='deleteTopic(<?php echo $row->tpc_id;?>)' href="#" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                      </tr>
                      <?php endforeach;?>
                    </tbody>
    ...
    <div class="modal fade" id="tambahTopic" tabindex="-1" role="dialog" aria-labelledby="tambahTopicLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="tambahTopicLabel">Tambah Topic</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form method="POST" action="topic_create.php">
              <div class="form-group">
                <label for="tpc_nama" class="col-form-label">Nama:</label>
                <input type="text" class="form-control" name="tpc_nama" id="tpc_nama" required>
              </div>
              <div class="form-group">
                <label for="tpc_deskripsi" class="col-form-label">Deskripsi:</label>
                <input type="text" class="form-control" name="tpc_deskripsi" id="tpc_deskripsi" required>
              </div>
          </div>
    ...
    function deleteTopic(id){
      if(confirm('Yakin ingin hapus')){
        document.location = 'topic_status.php?id='+id;
      }
    }
    $(document).ready(()=>{
      $('#addTopicbtn').on('click',function(e){
        $('#tambahTopic').modal('show');
      })
    })
    </script>
  </body>
